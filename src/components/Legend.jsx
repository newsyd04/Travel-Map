const Legend = ({ trips, onTripClick, selectedTrip }) => {
  return (
    <div className="p-4 bg-white shadow-lg rounded-lg max-w-full lg:max-w-xs self-start overflow-y-auto max-h-[400px]">
